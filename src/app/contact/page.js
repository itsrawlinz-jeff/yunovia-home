                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-6 col-lg-8">
                            <div className="banner-content">
                                <h1>Ready to Work Together? <br /> Let’s Connect</h1>
                    ...
                    <div className="row g-4">
                        <div className="col-lg-4 col-md-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="single-contact">
                                <h4>Nairobi</h4>
                                <a href="https://www.google.com/maps">Mitsumi Business Park
                                Westlands</a>
                                <ul className="contact-list">
                                    ...
                                    <li>
                                        ...
                                        <div className="content">
                                            ...
                                            <h6><a href="hello@yunoviagroup.co.ke">hello@yunoviagroup.co.ke</a></h6>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <form>
                                    <div className="row g-4">
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-inner">
                                                <label>Phone</label>
                                                <input type="text" placeholder="+254745******" />
                                            </div>
                                        </div>
