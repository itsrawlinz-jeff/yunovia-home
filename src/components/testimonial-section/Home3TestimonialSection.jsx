                ...
                <div className="row g-4 mb-70 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="col-lg-9">
                        <div className="section-title three">
                            <span>What Our Clients Say About Yunovia Group</span>
                            <div className="title-and-content">
                                <h2>They Loves Us.</h2>
                                <p>Redifining Brand Experiences and Digital Engagement For Our Clients</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="testimonial-content-wrap">
                                            <div className="author-area">
                                                <div className="author-img">
                                                    <img src="/assets/img/image-testimonial/andrew-test.png" alt="" />
                                                </div>
                                            ...
                                            <p>"Yunovi Transformed the way we manage our team and clients. The HRM feature simplified our payroll and performance tracking,
                                            while the CRM helped us close deals faster than ever. It is like having an extra department in cloud!"</p>
                                ...
                                <SwiperSlide className="swiper-slide">
                                    <div className="testimonial-card3">
                                        <div className="testimonial-content-wrap">
                                            <div className="author-area">
                                                <div className="author-img">
                                                    <img src="/assets/img/image-testimonial/julie-test.png" alt="" />
                                                </div>
                                                <div className="author-content">
                                                    <h5>Juliet Ntheya</h5>
                                                </div>
                                            ...
                                            <p>"We finaly have a handle on our inventory and procurement thanks to KREP's ERP system(Yunovia).
                                                It gives us real-time insights and control over our operations, helping us cut costs and improve efficiency"
                                            </p>
                                            <svg className="quote" width={70} height={52} viewBox="0 0 70 52" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path d="M16.7409 0.333496C26.4614 0.333496 33.4795 8.29592 33.4795 20.0871C33.4186 37.2167 20.4386 49.3279 1.71268 51.6529C-0.0220413 51.8703 -0.691584 49.4789 0.906189 48.7753C8.08856 45.6049 11.7193 41.5829 12.188 37.6032C12.538 34.629 10.9098 32.0231 8.86158 31.534C3.55697 30.2688 0.00230554 23.7135 0.00230554 16.9407C0.00230554 12.5362 1.76583 8.31211 4.90492 5.19765C8.04401 2.08318 12.3015 0.333496 16.7409 0.333496ZM53.2614 0.333496C62.982 0.333496 70 8.29592 70 20.0871C69.9391 37.2167 56.9591 49.3279 38.2332 51.6529C36.4985 51.8703 35.829 49.4789 37.4267 48.7753C44.6091 45.6049 48.2398 41.5829 48.7085 37.6032C49.0585 34.629 47.4303 32.0231 45.3821 31.534C40.0775 30.2688 36.5228 23.7135 36.5228 16.9407C36.5228 12.5362 38.2864 8.31211 41.4255 5.19765C44.5645 2.08318 48.8221 0.333496 53.2614 0.333496Z" />
                                ...
                                <SwiperSlide className="swiper-slide">
                                    <div className="testimonial-card3">
                                        <div className="testimonial-content-wrap">
                                            <div className="author-area">
                                                <div className="author-img">
                                                    <img src="/assets/img/image-testimonial/cate-test.png" alt="" />
                                                </div>
                                                <div className="author-content">
                                                    <h5>Catherine Kitula</h5>
                                                </div>
                                            </div>
                                            <span>Excellent Service!</span>
                                            <p>"KREP's all-in-one platform helped unify our sales, client communication and internal HR processes. The CRM tools alone improved our Customer
                                                response time by over 40%. Highly recommended for growing companies."
                                            </p>
                                            <svg className="quote" width={70} height={52} viewBox="0 0 70 52" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path d="M16.7409 0.333496C26.4614 0.333496 33.4795 8.29592 33.4795 20.0871C33.4186 37.2167 20.4386 49.3279 1.71268 51.6529C-0.0220413 51.8703 -0.691584 49.4789 0.906189 48.7753C8.08856 45.6049 11.7193 41.5829 12.188 37.6032C12.538 34.629 10.9098 32.0231 8.86158 31.534C3.55697 30.2688 0.00230554 23.7135 0.00230554 16.9407C0.00230554 12.5362 1.76583 8.31211 4.90492 5.19765C8.04401 2.08318 12.3015 0.333496 16.7409 0.333496ZM53.2614 0.333496C62.982 0.333496 70 8.29592 70 20.0871C69.9391 37.2167 56.9591 49.3279 38.2332 51.6529C36.4985 51.8703 35.829 49.4789 37.4267 48.7753C44.6091 45.6049 48.2398 41.5829 48.7085 37.6032C49.0585 34.629 47.4303 32.0231 45.3821 31.534C40.0775 30.2688 36.5228 23.7135 36.5228 16.9407C36.5228 12.5362 38.2864 8.31211 41.4255 5.19765C44.5645 2.08318 48.8221 0.333496 53.2614 0.333496Z" />
                                ...
                                <SwiperSlide className="swiper-slide">
                                    <div className="testimonial-card3">
                                        <div className="testimonial-content-wrap">
                                            <div className="author-area">
                                                <div className="author-img">
                                                    <img src="/assets/img/image-testimonial/vee-test.png" alt="" />
                                                </div>
                                                <div className="author-content">
                                                    <h5>Nancy Cherono</h5>
                                                </div>
                                            </div>
                                            <span>Fantastic Services!</span>
                                            <p>"Yunovi made so many things so easy to handle in the company. The HRM feature simplified our payroll and performance tracking,
                                            while the CRM helped us close deals faster than ever and the ERP helps us in managing our inventory."</p>
                                            <svg className="quote" width={70} height={52} viewBox="0 0 70 52" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path d="M16.7409 0.333496C26.4614 0.333496 33.4795 8.29592 33.4795 20.0871C33.4186 37.2167 20.4386 49.3279 1.71268 51.6529C-0.0220413 51.8703 -0.691584 49.4789 0.906189 48.7753C8.08856 45.6049 11.7193 41.5829 12.188 37.6032C12.538 34.629 10.9098 32.0231 8.86158 31.534C3.55697 30.2688 0.00230554 23.7135 0.00230554 16.9407C0.00230554 12.5362 1.76583 8.31211 4.90492 5.19765C8.04401 2.08318 12.3015 0.333496 16.7409 0.333496ZM53.2614 0.333496C62.982 0.333496 70 8.29592 70 20.0871C69.9391 37.2167 56.9591 49.3279 38.2332 51.6529C36.4985 51.8703 35.829 49.4789 37.4267 48.7753C44.6091 45.6049 48.2398 41.5829 48.7085 37.6032C49.0585 34.629 47.4303 32.0231 45.3821 31.534C40.0775 30.2688 36.5228 23.7135 36.5228 16.9407C36.5228 12.5362 38.2864 8.31211 41.4255 5.19765C44.5645 2.08318 48.8221 0.333496 53.2614 0.333496Z" />
                                                </g>
