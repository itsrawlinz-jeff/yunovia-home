                ...
                <div className="row align-items-center justify-content-between mb-60">
                    <div className="col-lg-5 col-md-8 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="section-title three">
                            <span>Delivering Smart Digital Solutions That Drive Real Impact</span>
                            <h2>Scope of Work.</h2>
                            <p>At Yunovia Group, our scope spans across strategy, design, development,
                                and digital infrastructure — all built to solve real-world business challenges 
                                and empower growth. Our services are structured into five core pillars</p>
                        </div>
                    </div>
                        ...
                        <div className="sevices-wrap">
                            <div className="single-services wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                ...
                                <div className="services-img">
                                    <img src="/assets/img/home3/ESD-service.png" alt="" />
                                </div>
                                <div className="content">
                                    <p>Custom-built ERP, CRM, HRM, and RMS systems to help businesses streamline operations, track performance, manage clients, and scale sustainably.<br></br>
                                    Tools: Krep Software, RMS (Real Estate Management System)</p>
                                </div>
                            </div>
                            <div className="single-services wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <div className="title-area">
                                    ...
                                    <h3>Creative & Digital Branding</h3>
                                </div>
                                <div className="services-img">
                                    <img src="/assets/img/home3/CDB-service.png" alt="" />
                                </div>
                                <div className="content">
                                    <p>Full-suite design and marketing services including websites, mobile apps, 
                                    UI/UX, brand identity, and digital campaigns.<br></br>
                                    Brand: Rawlinz Designs</p>
                                </div>
                            </div>
                            <div className="single-services wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div className="title-area">
                                    ...
                                    <h3>School & Institutional Systems</h3>
                                </div>
                                <div className="services-img">
                                    <img src="/assets/img/home3/school-service.png" alt="" />
                                </div>
                                <div className="content">
                                    <p>Smart platforms for school management, communication, academic reporting, and digital parent engagement.<br></br>
                                    Tool: Soma Flow</p>
                                </div>
                            </div>
                            <div className="single-services wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                <div className="title-area">
                                    ...
                                    <h3>Messaging & Communication Platforms</h3>
                                </div>
                                <div className="services-img">
                                    <img src="/assets/img/home3/message-service.png" alt="" />
                                </div>
                                <div className="content">
                                    <p>Bulk SMS systems that support mass communication, client outreach,
                                     and marketing campaigns with real-time analytics.<br></br>
                                    Tool: Bulk SMS Platform</p>
                                </div>
                            </div>
                            <div className="single-services wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                <div className="title-area">
                                    ...
                                    <h3>Hosting & Digital Infrastructure</h3>
                                </div>
                                <div className="services-img">
                                    <img src="/assets/img/home3/web-service.png" alt="" />
                                </div>
                                <div className="content">
                                    <p>Reliable, secure web hosting and domain services 
                                    to support all kinds of digital platforms and business websites.</p>
                                </div>
                            </div>
                        </div>
                    </div>
