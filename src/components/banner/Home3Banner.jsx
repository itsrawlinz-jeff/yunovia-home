                        ...
                        <div className="col-lg-6">
                            <div className="banner-content-wrap">
                                <div className="banner-content">
                                    <h1>Transforming Kenya's Digital Future One Brand At A Time.</h1>
                                    <p>We blend creatvity, technology <span>and strategy to create</span> unforgettable brand moments</p>
                                ...
                                <div className="banner-vector">
                                    ...
                                    <span>Unique Brands, <br />Bold Impact.</span>
                                </div>
                                <ul className="social-list">
                                    ...
                                    <li><a href="https://www.instagram.com/yunoviagroup/profilecard/?igsh=Z3ltNDMwMjAwaGoz"><i className="bx bxl-instagram" /></a></li>
