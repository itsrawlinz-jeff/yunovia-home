                    ...
                    <ul className="contact-list">
                      <li className="single-contact">
                        ...
                        <div className="content">
                          ...
                          <a href="mailto:info@example.com">hello@yunoviabrand.co.ke</a>
                        </div>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="row gy-5">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 d-flex justify-content-lg-center">
                      <div className="footer-widget">
                        ...
                        <ul className="widget-list">
                          <li><Link href="/industry/details">KREP Software</Link></li>
                          <li><Link href="/industry/details">Rawlinz Designs</Link></li>
                          <li><Link href="/industry/details">Somaflow</Link></li>
                          <li><Link href="/industry/details">Cheap Bulk Sms</Link></li>
                          <li><Link href="/industry/details">Web hosting</Link></li>
                          <li><Link href="/industry/details">Real Estate Management System </Link></li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div className="newsletter-area">
                        ...
                        <div className="social-area">
                          ...
                          <ul className="social-list">
                            ...
                            <li><a href="https://www.instagram.com/yunoviagroup"><i className="bx bxl-instagram-alt" /></a></li>
        ...
        <div className="footer-bottom">
          <div className="container">
            <div className="copyright-and-social-area">
              <p>Copyright 2025 <a href="https://www.egenslab.com/">Yunovia Group</a> | All Right Reserved.</p>
              <div className="terms-condition">
                ...
                <p>Our Business <a href="#">Policy</a></p>
