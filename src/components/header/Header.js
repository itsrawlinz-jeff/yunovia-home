                ...
                <div className="company-logo-and-contact-area">
                    ...
                    <div className="contact-area d-lg-flex d-none">
                        ...
                        <div className="content">
                            ...
                            <h6><a href="tel:+997636844568">+254-117-8888-90 </a></h6>
                        </div>
                    </div>
                </div>
                <div className="menu-and-btn-area">
                    <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
                        ...
                        <ul className="menu-list">
                            ...
                            <li className={`menu-item-has-children position-inherit ${pathname === "#" ? "active" : ""}`}>
                                <Link href="#" className="drop-down">Our Solutions
                                </Link>
                                                ...
                                                <ul className="menu-row">
                                                    ...
                                                    <li className="menu-single-item">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><Link href="#">Health &amp; Wellness</Link></li>
                                                            <li><Link href="#">Commerce &amp; Consumer Goods</Link></li>
                                                            <li><Link href="#">Education &amp; Innovation</Link></li>
                                                            <li><Link href="#">Public Sector &amp; NGOs</Link></li>
                                                            <li><Link href="#">Real Assets &amp; Infrastructure</Link></li>
                                                            <li><Link href="#">Transport &amp; Communications</Link></li>
                                                            <li><Link href="#">Lifestyle &amp; Entertainment</Link></li>
                                                            <li><Link href="#">Technology &amp; Media</Link></li>
                                                            <li>
